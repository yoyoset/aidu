...
本文档集中管理所�?Hard-coded Prompts，便于审查和优化�?
...
### 模式: DEEP (ID: 3)
�?STANDARD 类似，但要求更详细的 grammatical analysis explanation�?
...
**用法**: 注入�?`SmartRouter` �?System Prompt 中，控制 `explanation` 字段的风格�?
...
## 5. 改进计划建议
1. **字典查询**: 移除 12 字符限制，请求完�?Tier 1 数据 (JSON)�?
2. **文章分析**: 尝试�?STANDARD 模式直接输出高频词的 Tier 1 数据，减少后续查询�?
3. **风格�?*: �?System Prompt 中的身份定义 ("linguistic expert", "dictionary API") 变量化，支持 Teaching Persona�?
