...
> [!CAUTION]
> 本文档反映的是 v4.13.0 之前的旧版本单体架构，仅供历史参考。
> 请优先参考 [doc/architecture_v4.13.0.md](architecture_v4.13.0.md)。
...
> Traditional apps give you definitions; AIDU gives you **Lessons**. It treats every article like a textbook chapter, "preparing the lesson" (澶囪) for you by breaking down complex sentences, explaining cultural context, and ensuring you understand *why* a word is used, not just *what* it means.
...
*   **Concept**: "Article as a Lesson" (鏂囩珷鍗宠绋?.
*   **Feature**: When a user opens an article, the AI doesn't just translate. It:
    *   **Pre-reads**: Identifies闅剧偣 (pain points) and idioms.
